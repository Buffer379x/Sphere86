              ...
              <div className="space-y-6">
                ...
                <div className="card">
                  ...
                  <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1.5">
                      <label className="font-medium text-slate-900 dark:text-white flex items-center">
                        Target 86Box Version
                        <RestartHint />
                      </label>
                      <div className="flex gap-2">
                        ...
                        />
                        <button className="btn-secondary" onClick={() => saveSettings({ box86_version: formState.box86_version })}>Save</button>
                      </div>
                      <p className="text-xs text-slate-500">Leave blank to always use the latest release from GitHub.</p>
                    </div>
                    <div className="space-y-1.5">
                      <label className="font-medium text-slate-900 dark:text-white flex items-center">
                        Binary Architecture
                      ...
                      <div className="flex gap-2">
                        ...
                        <button className="btn-secondary" onClick={() => saveSettings({ box86_arch: formState.box86_arch })}>Save</button>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      {formState.ldap_enabled && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 border-t border-slate-100 dark:border-slate-800 mt-4">
                          ...
                          <div className="space-y-1">
                            ...
                            <input type="password" placeholder="********" className="input text-sm w-full" value={formState.ldap_bind_password || ''} onChange={e => setFormState(s => ({ ...s, ldap_bind_password: e.target.value }))} />
                          </div>
                          <div className="space-y-1">
                ...
                <div className="card overflow-hidden">
                  ...
                  <div className="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Default Max VMs per User</label>
                        <div className="flex gap-2">
                          <input type="number" className="input flex-1" value={formState.default_max_vms || 0} onChange={e => setFormState(s => ({ ...s, default_max_vms: parseInt(e.target.value) }))} />
                          <button className="btn-secondary" onClick={() => saveSettings({ default_max_vms: formState.default_max_vms })}>Save</button>
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Default Max Storage per User (GB)</label>
                        <div className="flex gap-2">
                          <input type="number" className="input flex-1" value={formState.default_max_storage_gb || 0} onChange={e => setFormState(s => ({ ...s, default_max_storage_gb: parseInt(e.target.value) }))} />
                          <button className="btn-secondary" onClick={() => saveSettings({ default_max_storage_gb: formState.default_max_storage_gb })}>Save</button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card">
                  ...
                  <div className="p-6 border-b border-slate-100 dark:border-slate-800 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1.5">
                      <label className="font-medium text-slate-900 dark:text-white flex items-center">
                        Base VNC Port
                        <RestartHint />
                      ...
                      <div className="flex gap-2">
                        <input type="number" className="input flex-1" value={formState.base_vnc_port || 5900} onChange={e => setFormState(s => ({ ...s, base_vnc_port: parseInt(e.target.value) }))} />
                        <button className="btn-secondary" onClick={() => saveSettings({ base_vnc_port: formState.base_vnc_port })}>Save</button>
                      </div>
                    </div>
                    <div className="space-y-1.5">
                      <label className="font-medium text-slate-900 dark:text-white flex items-center">
                      ...
                      <div className="flex gap-2">
                        <input type="number" className="input flex-1" value={formState.base_ws_port || 6000} onChange={e => setFormState(s => ({ ...s, base_ws_port: parseInt(e.target.value) }))} />
                        <button className="btn-secondary" onClick={() => saveSettings({ base_ws_port: formState.base_ws_port })}>Save</button>
                      </div>
                    </div>
                  </div>
                  <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1.5">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button className="btn-secondary" onClick={() => saveSettings({ log_level: formState.log_level })}>Save</button>
                      </div>
                    </div>
                    <div className="space-y-1.5">
                      <label className="font-medium text-slate-900 dark:text-white flex items-center">
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        <button className="btn-secondary" onClick={() => saveSettings({ audio_buffer_secs: formState.audio_buffer_secs })}>Save</button>
                      </div>
                      <p className="text-xs text-slate-500">Lower = less latency, higher = smoother audio.</p>
                    </div>
                  </div>
                </div>
